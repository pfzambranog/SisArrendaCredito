...
-- Objetivo:      Disparador de Alta y Actualización relacionado a la Entidad SO_RelUnidadProductoFinTbl
-- Fecha:         07-may-2026
-- Version:       2
--
...
Begin
   ...
   Select @w_idEstatusAnte = idEstatus
   From   Deleted;

   If @w_idEstatusAnte Is Not Null
      Begin
         If @w_idEstatusAnte > 2
            Begin
...
--
   ...
   If @w_id_Unidad Is Not Null
      Begin
         ...
         Join   dbo.SO_SolCondiciones_art d With (NOLOCK)
