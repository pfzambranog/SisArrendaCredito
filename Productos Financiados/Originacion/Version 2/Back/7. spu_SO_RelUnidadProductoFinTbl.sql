...
Begin
   Execute dbo.spu_SO_RelUnidadProductoFinTbl @PnId_Unidad           = @PnId_Unidad,
                                              @PnProd_Id             = @PnProd_Id,
...
--
   ...
   If @PnMontoFinanciar Is Not Null
      Begin
         Set @w_sql = Concat(@w_sql, ', MontoFinanciar = ', @PnMontoFinanciar);
      End
   ...
   If @PnTotalIntereses Is Not Null
      Begin
         Set @w_sql = Concat(@w_sql, ', totalIntereses = ', @PnTotalIntereses);
      End
   ...
   Set @w_sql = Concat(@w_sql, ' Where Id_Unidad = ', @PnId_Unidad,
                               ' And   prod_id   = ', @PnProd_Id);
